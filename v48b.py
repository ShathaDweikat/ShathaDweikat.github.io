#!/usr/bin/env python3
"""v48b: apply compact teaser sections to en/index.html using the actual comment separators."""

def make_card(icon, label_ar, label_en, desc, btn_label, href):
...
en_research_new = '''<section id="research" class="research-section cream-bg">
  <div class="container">
    ...
    <div class="whatido-grid reveal">
      ''' + make_card('landmark', 'Reshaping University Governance', 'Higher Education Governance',
